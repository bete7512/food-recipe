<template>
    ...
    <div class="flex">
        ...
        <div class="w-10/12 flex justify-center">
            <button
                class="flex  w-auto p-10 py-4 my-3 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Filter</button>
        </div>
        <div class="2/12">
    ...
    <div v-else class="flex">
        ...
        <div class="flex w-10/12 flex-wrap p-5 justify-center items-center space-x-3 ">
            <div class="card  mt-2 hover:scale-105 max-w-sm h-96 w-80 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
                ...
                <div class="relative">
                    <img class="rounded-t-lg w-full h-48" :src="JSON.parse(rec.images).split(',,,,')[2]" />
