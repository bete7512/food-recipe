<template>
    <div class="grid mt-10   sm:grid-cols-1 lg:grid-cols-3  p-20  bg-slate-200 w-full">
        <div>
    ...
    <div class="text-center font-bold bg-slate-200 w-full pb-3">All right resereved</div>
</template>
