<template >
    <settinglayoutVue>
            ...
            <div>
                <div class="flex justify-center">
                    ...
                    <div class="w-10/12 space-y-3 ">
                        ...
                        <div class="border p-10 rounded border-orange-500">
                            <div>
                                You have <span class="text-orange-500">{{user.users_counted_recipe}}</span> total
                                published recipe
                                <div>Thank You</div>
                            </div>
                        </div>
                                ...
                                <div class="card hover:border hover:shadow-xl h-auto hover:border-sky-800 duration-100 mt-2 hover:scale-100 max-w-sm  w-80 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="flex justify-between">
                                            <StarRating v-model:rating="recipe.rating" :read-only="true"
                                                :increment="0.01" :star-size="12">
                                            </StarRating>
                                            <div class="flex space-x-1 items-center">
                                                <button @click="managelikes(recipe.id, recipe.isliked)">
                                                    <svg v-if="recipe.isliked" xmlns="http://www.w3.org/2000/svg"
        ...
        <deleterecipeVue v-if="deleterecipe" :id="parseInt(delete_id)" v-on:deletenotify="successmodal = true"
            v-on:canceldelete="deleterecipe = false"></deleterecipeVue>
...
import deleterecipeVue from '../deleterecipe.vue';
...
const update_my_recipe = () => {

}
const successmodal = ref(false)
const notify = ref('Recipe DEleted successfully')
