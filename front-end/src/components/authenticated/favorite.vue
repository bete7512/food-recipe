            ...
            <div class="card hover:border-2 hover:border-sky-800 duration-300  mt-2 hover:scale-105 max-w-sm h-96 w-80 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
                ...
                <div class="p-3">
                    ...
                    <div class="flex justify-between">
                        <StarRating v-model:rating="rec.recipe.rating" :read-only="true" :increment="0.01"
                            :star-size="12"></StarRating>
                        <div class="flex space-x-1 items-center">
                            <button @click="managelikes(rec.recipe.id, rec.recipe.isliked)">
                                <svg v-if="rec.recipe.isliked" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
