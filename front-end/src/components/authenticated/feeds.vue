<template>
    ...
    <div v-else class="grid space-x-2 gap-x-3 justify-center  mx-28 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
                ...
                <div class="">
                    <div>
                        ...
                        <div class="flex space-x-3">
                            <div class="">
                                <div>{{ rec.Like_number }}</div>
                                <button class="" @click="manalikes(rec.id,rec.isliked)">
