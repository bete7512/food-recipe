<template>
    ...
    <div v-else class="grid space-x-2 gap-x-3 justify-center h-auto mx-28 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
        <div class="flex justify-center items-center my-3  transition-all hover:scale-105 rounded " v-for="rec in result.recipe" :key="rec.id">
          <div class="">
                  ...
                  <div>
                    <div><Strong>food name</Strong></div>
                      ...
                      <div class="flex space-x-3">
                          ...
                          <button v-if="isnotfavorite" @click="addtofavorite(rec.id)">
...
const {err,load,res} = useQuery(gql`
...
`)
    ...
    // const isfavorite = res.favorite.recipeid ? true:false
</script>
