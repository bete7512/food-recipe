<template>
    ...
    <div v-if="loading" class="flex justify-center items-center">
        <div role="status">
    <svg  class="flex items-center justify-center  w-32 h-32 my-20 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex justify-center mt-5"><button v-on:click="loadmore" type="submit"
                        class="flex items-center justify-center  px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">load more</button></div>
</template>
<script setup >
