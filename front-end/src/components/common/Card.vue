<template>
    <div
        class="card hover:border  hover:shadow-xl h-[450px]  hover:border-sky-800 duration-100 mt-2 sm:w-3/4 hover:scale-100 max-w-sm  md:w-3/4 lg:w-96 w-full sm:px-0  bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div class="relative h-[50%]">
            <img class="rounded-t-lg w-full h-[100%]" :src="JSON.parse(recipe.images).split(',,,,')[0]" />
            <button @click="managefavorite(recipe.id, recipe.isfavorite)"
                ...
                <div class="flex justify-center  pt-1 pl-3">
                    <svg v-if="recipe.isfavorite" style="color: red" xmlns="http://www.w3.org/2000/svg" width="26"
                    ...
                    <svg v-else style="color: red" xmlns="http://www.w3.org/2000/svg" width="26" height="26"
        ...
        <div class="p-5 h-[50%]">
            ...
            <div class="flex justify-between py-3">
                ...
                <div class="flex space-x-1 items-center">
                    <button @click="managelikes(recipe.id, recipe.isliked)">
                        <svg v-if="recipe.isliked" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="mb-1 text-xs font-normal text-gray-700 dark:text-gray-400 line-clamp-3">
                {{ recipe.descriptions }}</div>
            <div class="text-xs bottom-1 mb-3">By <router-link :to="{ name: 'userRecipe', params: { id: recipe.user.id } }">
