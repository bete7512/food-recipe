                    ...
                    <div class="w-full flex flex-wrap justify-center items-center p-5">
                        <div class="flex flex-wrap space-x-1   mt-5">
                            <div class="">
                                <div>
                                    <div>First name</div>
                                    <input v-model="fname" class="border p-3 border-gray-400 rounded h-10 w-full"
                                        name="" />
                                </div>
                                <div>
                                    <div>Last name</div>
                                    <input v-model="lname" class="border  p-3 border-gray-400 rounded h-10 w-full" name="" />
                                </div>
                            </div>
                            <div class="px-2">
                                <div>
                                    <div>email</div>
                                    <input v-model="email" class="border  p-3 border-gray-400 rounded h-10 w-full" name="" />
                                </div>
                            </div>
                            <div class=" w-full">
